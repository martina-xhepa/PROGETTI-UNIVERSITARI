...
public class TestCatERing {
    ...
    public static void main(String[] args) {
        try {
            ...
            Service service1 = allServices.get(1);
            System.out.println("SERVICE LOADED: " + service1.toString());

            System.out.println("-- OPEN SERVICE SHEET --");
            SummarySheet newSheet = instance.getEventManager().openSummarySheet(event, service1);
